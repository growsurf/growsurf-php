 ...
 *
 * @see Growsurf\Services\Campaign\ParticipantService::listReferrals()
 *
 * @phpstan-type ParticipantListReferralsParamsShape = array{
 *   id: string,
 *   desc?: bool|null,
 *   email?: string|null,
 ...
 * }
 */
final class ParticipantListReferralsParams implements BaseModel
{
    /** @use SdkModel<ParticipantListReferralsParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ParticipantListReferralsParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ParticipantListReferralsParams::with(id: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ParticipantListReferralsParams)->withID(...)
     * ```
     */
